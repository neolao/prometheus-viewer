...
**Role:** Lets the user pick which Prometheus machine (instance) to work on, with loading, empty and error states. Gates the metrics view — rendered by `app` before it shows `metrics`.
