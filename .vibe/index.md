...
## Modules
- [`modules/app.md`](modules/app.md) — entry point and root UI shell of the SPA, renders the metrics view directly
...
- [`modules/api-prometheus.md`](modules/api-prometheus.md) — client-side call to this app's own server proxy
